...
public class ResultVo {
     ...
     * @author hdj
     */
    public static ResultVo getSuccess(String msg, Object result, Integer totalCount) {
        return new ResultVo(HttpResponseEnum.SUCCESS.getCode(), msg, result, totalCount);
    }
    ...
    public static ResultVo getSystemError(String msg) {
        return new ResultVo(HttpResponseEnum.SYSTEM_ERROR.getCode(), msg);
    }
    ...
    public static ResultVo getParamError(String msg) {
        return new ResultVo(HttpResponseEnum.PARAM_ERROR.getCode(), msg);
    }
